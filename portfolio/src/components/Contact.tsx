    ...
    <section id="contact" className="relative py-20">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-dark-400 text-base sm:text-lg max-w-lg mx-auto mb-12 leading-relaxed">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <h3 className="text-sm font-semibold text-dark-200 mb-1">Email</h3>
            <p className="text-xs text-dark-500 break-all">{personalInfo.email}</p>
          </motion.a>
          ...
          >
            ...
            <p className="text-xs text-dark-500">Connect with me</p>
          </motion.a>
          ...
          >
            ...
            <h3 className="text-sm font-semibold text-dark-200 mb-1">GitHub</h3>
            <p className="text-xs text-dark-500">View my code</p>
          </motion.a>
        </div>
        ...
        >
          <a href={`mailto:${personalInfo.email}`} className="magnetic-btn">
