      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <h3 className="text-base font-semibold text-dark-200 mb-1">Email</h3>
            <p className="text-sm text-dark-500 break-all">{personalInfo.email}</p>
          </motion.a>
          ...
          >
            ...
            <p className="text-sm text-dark-500">Connect with me</p>
          </motion.a>
          ...
          >
            ...
            <h3 className="text-base font-semibold text-dark-200 mb-1">GitHub</h3>
            <p className="text-sm text-dark-500">View my code</p>
          </motion.a>
        </div>
